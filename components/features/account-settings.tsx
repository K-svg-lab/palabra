...
import { DeepLearningToggle } from '@/components/features/deep-learning-toggle';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {/* Phase 18.2.2: Deep Learning Mode - PREMIUM */}
        <DeepLearningSection />
      </div>
...
/**
 * Deep Learning Section Component
 * Separated for clarity - handles premium feature gating
    ...
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3 sm:p-4 mt-4">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">
            Research-backed elaborative interrogation for deeper memory retention
          </p>
        </div>
      ...
      {/* Frequency Selector (only when premium AND enabled) */}
      {isPremium && preferences.deepLearningEnabled && (
        <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-800">
      ...
      <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-800">
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">
            <strong>Research-backed:</strong> Elaborative interrogation (asking "why/how" questions) 
            improves retention with a medium-large effect size (d = 0.71). 
            Based on Pressley et al. (1988) and Woloshyn et al. (1992).
          </p>
        </div>
      </div>
    </div>
